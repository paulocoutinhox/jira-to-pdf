...
func parseIssueTemplate(index int, issue jira.Issue) string {
	...
	issueText = strings.Replace(issueText, "[issue.fields.duedate]", time.Time(issue.Fields.Duedate).Format(paramDateTimeFormat), -1)
	issueText = strings.Replace(issueText, "[issue.fields.expand]", issue.Fields.Expand, -1)
	issueText = strings.Replace(issueText, "[issue.fields.resolutiondate]", time.Time(issue.Fields.Resolutiondate).Format(paramDateTimeFormat), -1)
